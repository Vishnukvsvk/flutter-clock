...
final _lightTheme = {
  _Element.background: Colors.green[500],
...
class _DigitalClockState extends State<DigitalClock> {
  ...
  Widget build(BuildContext context) {
    ...
    final day = DateFormat('EEEE, d MMM, yyyy').format(_dateTime);
    final tempSize = MediaQuery.of(context).size.width / 12.0; //7 INTIAL
    final iconSize = MediaQuery.of(context).size.width / 6; //5 INTIAL
